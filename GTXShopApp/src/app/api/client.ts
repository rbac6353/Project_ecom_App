...
// Base URL - Backend บน Render (ใช้ทั้งตอน dev และ production)
const RENDER_API_URL = 'https://project-ecom-backend.onrender.com';

// ถ้าอยากทดสอบกับ Backend รันบนเครื่องเอง ให้ return 'http://10.0.2.2:3000' (Android) หรือ 'http://<IP คอม>:3000'

export const getApiBaseUrl = () => {
  if (__DEV__) {
    // Development mode - ชี้ไป Render เพื่อดึงข้อมูลจริงจาก TiDB
